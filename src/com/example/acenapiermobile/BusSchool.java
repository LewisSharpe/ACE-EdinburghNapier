...
public class BusSchool extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
     ...
     // BUTTON TO MOVE TO CRAIGLOCKHART CAMPUS PICTURE GALLERY WINDOW
        Button CCampusPictureGallery = (Button) findViewById(R.id.btnCCampusPictureGallery);
        CCampusPictureGallery.setOnClickListener(new OnClickListener()
        
        {
    		public void onClick(View v)
    		{
    			Intent movetoCCampusPictureGallery = new Intent(BusSchool.this, CCampusPictureGallery.class); // once clicked on move user to craiglockhart campus pg window
    			
    			startActivity(movetoCCampusPictureGallery);
    		}
        });
