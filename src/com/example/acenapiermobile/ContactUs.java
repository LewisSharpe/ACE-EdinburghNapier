...
public class ContactUs extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// BUTTON TO DEPARTMENT CONTACTS WINDOW
        ...
        
        {
			...
			{
				Intent movetoDeptContacts = new Intent(ContactUs.this, DeptContacts.class); // once clicked on move user to department contacts window
