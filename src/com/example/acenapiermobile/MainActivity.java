...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView ace_logo = (ImageView) findViewById(R.id.imageLogo);
     ...
     // BUTTON TO MOVE TO FINDING COURSE WINDOW
        Button FindingCourse = (Button) findViewById(R.id.btnFindingCourse);
        FindingCourse.setOnClickListener(new OnClickListener()
        
        {
    		public void onClick(View v)
    		{
    			Intent movetoFindingCourse = new Intent(MainActivity.this, FindingCourse.class); // once clicked on move user to finding course window
    			
    			startActivity(movetoFindingCourse);
    		}
        });
